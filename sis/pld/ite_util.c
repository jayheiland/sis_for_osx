  ...
  ite_vertex *ite;
{
  ...
  if (ite == NIL (ite_vertex)) return 0;
...
{
  if (vertex->mark == MARK_COMPLEMENT_VALUE) return 0;
  vertex->mark = MARK_COMPLEMENT_VALUE;
  if (vertex->value <= 1) return 0;
